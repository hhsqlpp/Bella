...
const CardSlider = ({ freshness, sale, title }) => {
    ...
    <div className={styles.cards__item}>
      ...
      <div className={styles.cards__item__info}>
        <div className={styles.cards__item__prices}>
          <span className={styles.cards__item__prices__before}>12000 c.</span>
          <span className={styles.cards__item__prices__after}>12000 c.</span>
        </div>
        {sale && <div className={styles.cards__item__sale}>{sale}%</div>}
        <span className={styles.cards__item__name}>{title}</span>
        <div className={styles.cards__item__sizes}>Размеры: 45-46</div>
