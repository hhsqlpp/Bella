...
export default function ProductItem({ sale, favorite, freshness, data }) {
    ...
    <div className={styles.cards__item}>
      ...
      <div className={styles.cards__item__info}>
        <div className={styles.cards__item__prices}>
          <span className={styles.cards__item__prices__before}>
            {data.price} c.
          </span>
          <span className={styles.cards__item__prices__after}>
            {data.new_price} c.
          </span>
        </div>
        <div className={styles.cards__item__sale}>{data.discount}%</div>
        <span className={styles.cards__item__name}>{data.title}</span>
        <div className={styles.cards__item__sizes}>
          Размеры: {data.sizes[0].name}
        </div>
        <div className={styles.cards__item__colors}>
          <span
            className={(styles.cards__item__colors__item, styles.active)}
          ></span>
          <span className={styles.cards__item__colors__item}></span>
          <span className={styles.cards__item__colors__item}></span>
          <span className={styles.cards__item__colors__item}></span>
          <span className={styles.cards__item__colors__item}></span>
          <span className={styles.cards__item__colors__item}></span>
